...
class MonopedState(object):
    ...
    def __init__(self, max_height,interval, min_height, abs_max_roll, abs_max_pitch, joint_increment_value = 0.05, done_reward = -1000.0, alive_reward=10.0, weight_r1=1.0, weight_r2=1.0,weight_r5=1.0,weight_r6=1.2, discrete_division=10):
        ...
        rospy.Subscriber('/darwin/joint_states', JointState)
    ...
    def darwin_distance(self):
        ...
        distance_ok = self.base_position.x >= self.desired_world_point.x 
        return distance_ok
    ...
    def calculate_reward_interval(self, weight=10):
    ...
    def get_observations(self):
        ...
        joint_states_ankle1_r = joint_states.position[0]
        joint_states_ankle2_r = joint_states.position[1]
        joint_states_pelvis_r = joint_states.position[2]
        joint_states_j_tibia_r = joint_states.position[3]
        joint_states_thigh2_r = joint_states.position[4]
        joint_states_thigh1_r = joint_states.position[5]
    ...
    def process_data(self):
        ...
        :return: reward, done
        """
        darwin_distance_ok = self.darwin_distance()
        darwin_interval_ok = self.darwin_interval()
        #monoped_orientation_ok = self.monoped_orientation_ok()

        done = darwin_distance_ok and darwin_interval_ok  #and monoped_orientation_ok
        if done:
